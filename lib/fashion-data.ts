...
export const products: Product[] = [
  { name: 'The Column Coat', collection: 'men', category: 'Outerwear / Men', price: '£420', image: '/images/products/men/men3.jpg', fallbackImage: 'https://images.unsplash.com/photo-1539533018447-63fcce2678e3?auto=format&fit=crop&w=1000&q=85', imageAlt: 'VERRA men\'s column coat' },
  { name: 'The Studio Overshirt', collection: 'men', category: 'Layers / Men', price: '£240', image: '/images/products/men/men1.jpg', fallbackImage: 'https://images.unsplash.com/photo-1617127365659-c47fa864d8b8?auto=format&fit=crop&w=1000&q=85', imageAlt: 'VERRA men\'s studio overshirt styled in rust brown' },
