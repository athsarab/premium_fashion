...
export const collections: Collection[] = [
  {
    ...
    longDescription: 'Our debut collection blending anime-inspired artistry with premium streetwear. Every piece is a canvas for self-expression — bold graphics meet considered construction, creating wearable art that speaks your language.',
