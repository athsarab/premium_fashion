...
import { heroImage } from '@/lib/fashion-data'
...
export default function Home() {
  return <PageShell><main><Hero image={heroImage} /><EditorialIntro /><section id="collections"><CollectionChapter collection="men" index={1} /><CollectionChapter collection="women" index={2} /><CollectionChapter collection="kids" index={3} /></section><Featured /><CategoryBrowser /><SignatureBreak /><Footer /></main></PageShell>
}
